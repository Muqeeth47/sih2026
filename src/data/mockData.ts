...
export const DEMO_ROLES = [
  {
    ...
    label: 'Sub Inspector',
    fullTitle: 'Sub Inspector (Field IO)',
    badge: 'Sub Inspector',
    pin: '1234',
    name: 'Sub Inspector',
    unit: 'NCB Field Unit',
  ...
  },
  {
    ...
    label: 'Forensic Lab',
    fullTitle: 'Forensic Lab Analyst',
    badge: 'Forensic Lab',
    pin: '1234',
    name: 'Forensic Lab Officer',
    unit: 'CFSL Forensic Lab',
    color: '#7c3aed',
  },
  {
    role: 'ncb_zonal' as const,
    label: 'Zonal Officer',
    fullTitle: 'Zonal Officer (HQ)',
    badge: 'Zonal Officer',
    pin: '1234',
    name: 'Zonal Officer',
    unit: 'NCB Zonal HQ',
  ...
  },
  {
    ...
    label: 'Court',
    fullTitle: 'NDPS Court Reader',
    badge: 'Court',
    pin: '1234',
    name: 'Court Officer',
    unit: 'Special NDPS Court',
    color: '#138808',
  },
];
