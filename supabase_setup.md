# DRUG-SEAL AI — Supabase Database Setup & Schema Guide

**Project**: DRUG-SEAL AI (SIH26231 — Ministry of Home Affairs / Narcotics Control Bureau)  
**Database**: PostgreSQL 15+ (Supabase Cloud)  
**Project Reference**: prndinkwjyfphewqlhqv  
**Endpoint**: https://prndinkwjyfphewqlhqv.supabase.co

---

## 1. How to Apply This Schema

1. Log in to your [Supabase Dashboard](https://supabase.com/dashboard/project/prndinkwjyfphewqlhqv).
2. Click on **SQL Editor** from the left navigation bar.
3. Click **+ New Query**.
4. Paste the complete SQL code from Section 3 below.
5. Click **Run** (or press Ctrl+Enter).
6. Verify in the **Table Editor** that the 4 tables (seizures, scan_assays, panchnama_records, custody_chain) and the storage bucket (orensic_reports) are created.

---

## 2. Architecture Overview

- **public.seizures**: Central registry of all contraband seizures with status workflow.
- **public.scan_assays**: Colorimetric assay data containing OpenCV CIELAB/Delta-E metrics and Gemini 3.6 Flash multimodal review.
- **public.panchnama_records**: Statutory Form F / NDPS Act Sec 52 field seizure memos and magistrate verification.
- **public.custody_chain**: SHA-256 immutable custody tracking automatically populated via database trigger.
- **storage.forensic_reports**: Public storage bucket for tamper-evident PDF test reports.
- **supabase_realtime**: Real-time publication for instant cross-portal updates across Field IO, FSL Lab, HQ, and Court.
...
## 4. Environment Variables Required for Production / Vercel
